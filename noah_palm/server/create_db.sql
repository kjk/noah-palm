...
-- an old version of request_log for Palm client 0.5
...
(
  cookie     VARCHAR(64)  NOT NULL,          -- 64 just to be sure
  reg_code   VARCHAR(64)  NULL DEFAULT NULL, -- 64 just to be sure
  word       VARCHAR(255) BINARY NOT NULL,
  query_time TIMESTAMP NOT NULL,
  INDEX idx1 (cookie),
  INDEX idx2 (reg_code)
...
(
  ...
  client_ver    TEXT NOT NULL DEFAULT '0.5' -- added for Palm client 1.0
  protocol_ver  TEXT NOT NULL DEFAULT '1'   -- added for Palm client 1.0
