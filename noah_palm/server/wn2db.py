...
# 05/31/2002 - god only knows when this has been started
# 06/01/2002 - adding windows format: added list of words
# 06/18/2002 - changes to the format, fixed pychecker bugs
# 06/27/2002 - win converter work
# 06/28/2002 - finished win converter
# 07/05/2002 - changed to produce little-endian numbers
# 08/08/2002 - read words from eng-pol dict for Noah Lite filtering

# A script to convert WordNet data into
#  - Noah for Windows format
#  - (maybe) SQL format to put into the database
#  - (maybe) Noah for Palm format
...
# name of the generated *sql file to feed to PostgreSQL
sqlFileName = "noah_stuff.sql"

# name of the generated Windows format file  
winProFileName = "NoahPro.wdb"
winLiteFileName = "NoahLite.wdb"
