...
(defun do-all-fast ()
  (let* ((hash (make-engpol-words-hash))
	...
	(accept-small (make-wn-accept-hook-small hash)))
;;    (do-devil)
    (do-wordnet-limit accept-mini "WN mini" "wn_mini.pdb" 't 't)
    (do-wordnet-limit accept-mini "WN mini lite" "wn_mini_lite.pdb" nil 't)
    (do-wordnet-limit accept-small "WN small" "wn_small.pdb" 't 't)
    (do-wordnet-limit accept-small "WN small lite" "wn_small_lite.pdb" nil 't)
    (do-wordnet-limit accept-medium "WN  medium" "wn_medium.pdb" 't 't)
    (do-wordnet-limit accept-medium "WN medium lite" "wn_medium_lite.pdb" nil 't)
    (do-wordnet-limit accept-advanced "WN advanced" "wn_advanced.pdb" 't 't)
    (do-wordnet-limit accept-advanced "WN advanced lite" "wn_advanced_lite.pdb" nil 't)
    (do-wordnet-full "WN full" "wn_full.pdb" 't 't)
    (do-wordnet-full "WN full lite" "wn_full_lite.pdb" nil 't))
    (do-wordnet-demo "WN demo" "wn_demo.pdb"))
